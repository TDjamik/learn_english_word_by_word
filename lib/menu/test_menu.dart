...
class TestMenu extends Menu {
  ...
  Future<String> missingLetter() async{
    ...
    list = List.generate(directory
        .listSync()
        .length, (index) {
      return directory.listSync()[index].path
          .split("/")
          .last
          .split("\\")
          .last;
    ...
    print('\t\t\t' +
        'percent'.tr +
        '=> ' +
        ((t * 100) / list.length).toStringAsFixed(2) +
        '%' +
        '\n\n\n');
  ...
  Future<String> comparison() async{
    ...
    for (int i = 0; i < list2.length; i++) {
      ...
      translation =
      jsonDecode(File(directory.path + "/${list2[i]}").readAsStringSync())[
      "translation"];
      translation1 =
      jsonDecode(File(directory.path + "/$catcher1").readAsStringSync())[
      "translation"];
      translation2 =
      jsonDecode(File(directory.path + "/$catcher2").readAsStringSync())[
      "translation"];
      translation3 =
      jsonDecode(File(directory.path + "/$catcher3").readAsStringSync())[
      "translation"];
